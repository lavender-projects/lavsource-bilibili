...
TERMUX_ENV_PATH="$PROJECT_PATH/app/src/main/assets/termux"
LAVSOURCE_SERVER_PATH="$PROJECT_PATH/app/src/main/assets/lavsource-server"
...
cd "$PROJECT_PATH/../lavsource-bilibili-server"
rm -f ./build/libs/*.jar
chmod +x gradlew
./gradlew build
